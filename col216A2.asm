...
StackSizeMoreThanOneInTheEndErrorMsg: .asciiz "Unused Stack Error: More than one element remaining in stack at the end -> Program Terminated."

maxLenOfUserInput = 1000 # in Bytes
maxStackSize = 1000 #1000/4 = 250 bytes because we store integers in stack. 
